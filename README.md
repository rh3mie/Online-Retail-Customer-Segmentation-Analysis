...
This project aims to identify different customer groups based on their purchasing behavior through RFM analysis, K-means clustering, and Cohort analysis. This will help this company create data-informed marketing strategies to improve customer retention and increase revenue. This project will also conduct a general analysis of the store's business, providing insights into sales trends, customer behavior, popular products, and performance over time. All code is available in ```uci_retail_segmentation.ipynb```.
